...
namespace GUI.DAO
{
    public class AccountDAO
    {
        ...
        public static bool UpdateAccount(string username, int accountType, string idNV)
        {
            string command = string.Format("USP_UpdateAccount  @username = '{0}', @loaiTK = '{1}', @idNV = '{2}' ", username, accountType, idNV);
