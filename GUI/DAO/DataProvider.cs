...
namespace GUI.DAO
{
    public class DataProvider
    {
        ...
        private static string connectionSTR = Properties.Settings.Default.QLRPConnectionString;//= "Data Source=THAITHANG-PC;Initial Catalog=QuanLyRapPhim;User ID=sa;pwd=thaithang1";
